...
./buildPostman.sh v3-2023-05-15/openapi.yaml v3-2023-05-15/postman/ecolytiq_Sandbox.postman_collection.json

redoc-cli build v3-2023-05-15/openapi.yaml --options=theme.json --disableGoogleFont -t ecolytiq.hbs
cp redoc-static.html v3-2023-05-15/index.html
